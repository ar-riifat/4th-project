                ...
                <div class="row align-items-center">
                    <div class="header-text mb-2">
                     ...
                     <div class="mb-3">
                            ...
                            <input type="text" class="form-control form-control-lg bg-light fs-6" placeholder="Company Name" name="company_name" required>
                        </div>
                        <div class="mb-3">
                            <textarea class="form-control bg-light fs-6" placeholder="Company Address" name="company_address" rows="2" ></textarea>
                        </div>
                        <div class="mb-3">
                         <input class="form-control form-control-lg bg-light fs-6" type="text" name="website" placeholder="Company Website" >
                        </div>
                        <div class="mb-3">
                       ...
                       <div class='mb-3'>
                            <input type="country" class="form-control form-control-lg bg-light fs-6" placeholder="Country Name" name="r_country">
                       </div>
                        <div class="mb-3">
